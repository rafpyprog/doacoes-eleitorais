...
% ---
\usepackage[scaled]{uarial} % Usa a fonte Arial
...
\usepackage{setspace}           % para definição de espaço entre parágrafos
% ---
...
{\fancyhf{}	
	...
	\fancyhead[R]{\thepage \vspace{1cm} \hspace{-10pt}}
	\fancyhead[C]{}% Emp
	\fancyhead[L]{\includegraphics[height=1.6cm ,keepaspectratio=true]
		{header_igti.jpg}}
...
% ---
\titulo{CLASSIFICAÇÃO DE RECEITAS E DESPESAS ELEITORAIS: \\ESTUDO DE CASO DAS ELEIÇÕES MUNICIPAIS PARA PREFEITO DE SÃO PAULO}
...
\hypersetup{
     	%pagebackref=true,
		pdftitle={\@title Classificando Receitas e Despesas Eleitorais: Estudo de Caso das Eleições Municipais para Prefeito da Cidade de São Paulo}, 
		pdfauthor={\@author Rafael Alves Ribeiro},
...
% ---
\setlrmarginsandblock{3cm}{2.09cm}{*}
...
\setlength\aftersecskip{18pt} % Espaço duplo entre o título da seção e a primeira linha
...
\begin{resumoumacoluna}
	\begin{SingleSpace}
		...
		abaixo do resumo, antecedidas da expressão Palavras-chave:, separadas entre si por ponto e finalizadas também por ponto. 
		\vspace{\onelineskip} 
		\noindent
...
Encorajamos que sejam reealizadas customizações específicas deste documento.
